          ...
          return (
            ...
            >
              <div className="p-6 md:p-10 h-full flex flex-col">
                <div className="flex items-start justify-between mb-8">
                  ...
                  <span
                    className={`inline-flex items-center gap-2 font-mono text-[10px] tracking-[0.3em] uppercase px-2 py-1 border ${
                      ongoing
                        ? 'border-peach text-peach bg-peach-dim'
                        : 'border-border-soft text-muted'
                    }`}
                  >
                    {ongoing ? (
                      <span className="pulse-dot relative inline-block h-1.5 w-1.5 bg-peach rounded-full" />
                    ) : (
                ...
                <h3
                  className="font-display font-semibold text-ink leading-[0.9] mb-4 group-hover:text-peach transition-colors"
