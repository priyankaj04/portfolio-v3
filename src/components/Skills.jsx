          ...
          {GROUPS.map((group, gi) => (
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-5">
                <span className="font-mono text-[11px] tracking-[0.32em] uppercase text-blue">
                  {group.n}
                </span>
              ...
              <div className="flex flex-wrap gap-2">
                {skills[group.key].map((skill, si) => (
                  <motion.span
                    ...
                    className="group inline-flex items-center gap-2 px-4 py-2 border border-line hover:border-blue hover:bg-blue-dim transition-all duration-300 rounded-full"
                    data-hover
                  >
                    <span className="font-mono text-[10px] text-muted group-hover:text-blue transition-colors">
                      [
                    </span>
                    <span className="font-syne text-sm text-ink/85 group-hover:text-blue transition-colors">
                      {skill}
                    </span>
                    <span className="font-mono text-[10px] text-muted group-hover:text-blue transition-colors">
                      ]
