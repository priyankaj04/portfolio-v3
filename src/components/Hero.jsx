  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle, rgba(29, 78, 216,0.18) 0%, rgba(29, 78, 216,0.04) 40%, transparent 70%)',
        }}
      />
        ...
        <div className="w-full flex flex-col items-center text-center">
          ...
          >
            <motion.span
              ...
              className="block"
            >
              Priyanka<span className="text-blue">.</span>
            </motion.span>
            <motion.span
              initial={{ opacity: 0, y: 80 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="flex items-center gap-4">
              <span className="block h-px w-10 bg-blue" />
            ...
            <p className="mt-6 font-sans text-lg md:text-2xl text-ink/80 leading-relaxed text-center">
              <span className="text-blue align-top">&ldquo;</span>
              {meta.tagline}
              <span className="text-blue align-bottom">&rdquo;</span>
            </p>
          </motion.div>
          ...
          >
            <a
              href="#projects"
              className="group inline-flex items-center gap-3 px-6 py-4 bg-blue text-bg font-syne text-xs md:text-sm tracking-[0.28em] uppercase font-semibold transition-all hover:bg-ink hover:shadow-[0_0_40px_rgba(29, 78, 216,0.35)]"
            >
              View work
            ...
            <a
              href="#contact"
              className="group inline-flex items-center gap-3 px-6 py-4 border border-border-soft text-ink font-syne text-xs md:text-sm tracking-[0.28em] uppercase font-semibold transition-all hover:border-blue hover:text-blue"
            >
              Get in touch
              <span className="transition-transform duration-300 group-hover:translate-x-1">↗</span>
            </a>
