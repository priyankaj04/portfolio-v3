          ...
          <div className="border-y border-border-soft">
            {rows.map((row, i) => (
              <motion.a
                ...
                className="group grid grid-cols-12 gap-3 items-center py-5 md:py-7 border-b border-border-soft last:border-0 hover:bg-blue-dim transition-colors px-2 -mx-2"
                data-hover
              >
                <div className="col-span-1 font-mono text-blue text-lg">{row.icon}</div>
                <div className="col-span-3 md:col-span-2 font-mono text-[10px] tracking-[0.3em] uppercase text-muted">
                  {row.label}
                </div>
                <div className="col-span-7 md:col-span-8 font-syne text-base md:text-2xl text-ink group-hover:text-blue transition-colors truncate">
                  {row.display}
                </div>
                <div className="col-span-1 text-right font-mono text-muted group-hover:text-blue group-hover:translate-x-1 transition-all">
                  ↗
                </div>
              </motion.a>
            ))}
  ...
  return (
    <div className="relative w-full max-w-[400px] aspect-square">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(circle at 50% 50%, rgba(29, 78, 216,0.20) 0%, transparent 65%)',
        }}
      />
      ...
      <svg viewBox="0 0 360 360" className="relative w-full h-full">
        ...
        {/* Corner crosshairs */}
        <g stroke="#1d4ed8" strokeWidth="1.2">
