      ...
      >
        <svg viewBox="0 0 440 440" className="w-full h-auto block">
          ...
          >
            ...
            <circle cx="220" cy="90" r="4.5" fill="#10b981" />
          ...
          >
            ...
            <circle cx="300" cy="220" r="3.5" fill="#10b981" />
          </motion.g>

          {/* Core */}
          <circle cx="220" cy="220" r="32" stroke="#10b981" strokeWidth="1" fill="none" opacity="0.4" />
          <circle cx="220" cy="220" r="22" stroke="#10b981" strokeWidth="1" fill="none" opacity="0.6" />
          <motion.circle
            cx="220"
            cy="220"
            r="10"
